...
Referring to my implementation notes of \texttt{FRD} in dps8_math.c...
...
This is either a hack, bug or an undocumented feature. \texttt{MVT} instruction in dps8_eis.c has been modified to set the TALLY bit as well as the TRUNC bit uon overflow

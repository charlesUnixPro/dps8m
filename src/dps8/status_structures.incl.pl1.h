...
typedef struct __attribute__ ((__packed__)) status_branch
  {
        ...
        union
          {
            struct __attribute__ ((__packed__))
              {
                uint ring_brackets : 18; // (0:2) bin (6)
                uint pad3 : 5;
                uint synchronized_switch : 1;
                uint damaged_switch : 1;
                uint mdir_switch : 1;
                uint tpd_switch : 1;
                uint copy_switch : 1;
                uint pad2 : 8;

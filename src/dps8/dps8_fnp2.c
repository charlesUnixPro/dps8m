...
//sim_printf ("associated %c.%03d %p\n", fnpno + 'a', lineno, client);
    ...
    fnpUnitData[fnpno].MState.line[lineno].inputBufferSize = 0;
    fnpUnitData[fnpno].MState.line[lineno].ctrlStrIdx = 0;
    fnpUnitData[fnpno].MState.line[lineno].breakAll = false;
    fnpUnitData[fnpno].MState.line[lineno].handleQuit = false;
    fnpUnitData[fnpno].MState.line[lineno].echoPlex = false;
    fnpUnitData[fnpno].MState.line[lineno].crecho = false;
    fnpUnitData[fnpno].MState.line[lineno].lfecho = false;
    fnpUnitData[fnpno].MState.line[lineno].tabecho = false;
    fnpUnitData[fnpno].MState.line[lineno].replay = false;
    fnpUnitData[fnpno].MState.line[lineno].polite = false;
    fnpUnitData[fnpno].MState.line[lineno].prefixnl = false;
    fnpUnitData[fnpno].MState.line[lineno].eight_bit_out = false;
    fnpUnitData[fnpno].MState.line[lineno].eight_bit_in = false;
    fnpUnitData[fnpno].MState.line[lineno].odd_parity = false;
    fnpUnitData[fnpno].MState.line[lineno].output_flow_control = false;
    fnpUnitData[fnpno].MState.line[lineno].input_flow_control = false;
    fnpUnitData[fnpno].MState.line[lineno].block_xfer_in_frame_sz = 0;
    fnpUnitData[fnpno].MState.line[lineno].block_xfer_out_frame_sz = 0;
    memset (fnpUnitData[fnpno].MState.line[lineno].delay_table, 0, sizeof (fnpUnitData[fnpno].MState.line[lineno].delay_table));
    fnpUnitData[fnpno].MState.line[lineno].inputSuspendLen = 0;
    memset (fnpUnitData[fnpno].MState.line[lineno].inputSuspendStr, 0, sizeof (fnpUnitData[fnpno].MState.line[lineno].inputSuspendStr));
    fnpUnitData[fnpno].MState.line[lineno].inputResumeLen = 0;
    memset (fnpUnitData[fnpno].MState.line[lineno].inputResumeStr, 0, sizeof (fnpUnitData[fnpno].MState.line[lineno].inputResumeStr));
    fnpUnitData[fnpno].MState.line[lineno].outputSuspendLen = 0;
    memset (fnpUnitData[fnpno].MState.line[lineno].outputSuspendStr, 0, sizeof (fnpUnitData[fnpno].MState.line[lineno].outputSuspendStr));
    fnpUnitData[fnpno].MState.line[lineno].outputResumeLen = 0;
    memset (fnpUnitData[fnpno].MState.line[lineno].outputResumeStr, 0, sizeof (fnpUnitData[fnpno].MState.line[lineno].outputResumeStr));
    fnpUnitData[fnpno].MState.line[lineno].frame_begin = 0;
    fnpUnitData[fnpno].MState.line[lineno].frame_end = 0;
    memset (fnpUnitData[fnpno].MState.line[lineno].echnego, 0, sizeof (fnpUnitData[fnpno].MState.line[lineno].echnego));
    fnpUnitData[fnpno].MState.line[lineno].echnego_len = 0;
    fnpUnitData[fnpno].MState.line[lineno].line_break = false;
    ltnRaw (p->telnetp);
  }

    ...
    switch (decoded.op_code)
      {
        case  1: // disconnect_this_line
          {
            // I suppose that this should cause the TCP connection to be
            // dropped, but not for now. If so, the fnp_rcd_line_disconnected
            // should be generated by libuv on the disconnect callback.

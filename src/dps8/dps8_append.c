...
// START APPEND
    ...
    if (! instructionFetch && i -> a)
      {
        L68_ (cpu.apu.state |= apu_ESN_SNR;)
        word3 n = GET_PRN(IWB_IRODD);  // get PRn

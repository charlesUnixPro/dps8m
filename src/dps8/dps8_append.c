...
void do_ldbr (word36 * Ypair)
  {
    ...
    //sim_printf ("CPU %c ldbr %012"PRIo64" %012"PRIo64"\n", 'A' + thisCPUnum, Ypair [0], Ypair [1]);
    //sim_printf ("CPU %c ldbr DSBR.ADDR %08o, DSBR.BND %05o, DSBR.U %o, DSBR.STACK %04o\n", 'A' + thisCPUnum, cpu.DSBR.ADDR, cpu.DSBR.BND, cpu.DSBR.U, cpu.DSBR.STACK); 
  }

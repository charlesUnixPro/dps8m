...
static REG cpu_reg[] = {
    ...
    { ORDATA (PR0.BITNO, PR[0].BITNO, 18) },
    { ORDATA (PR1.BITNO, PR[1].BITNO, 18) },
    { ORDATA (PR2.BITNO, PR[2].BITNO, 18) },
    { ORDATA (PR3.BITNO, PR[3].BITNO, 18) },
    { ORDATA (PR4.BITNO, PR[4].BITNO, 18) },
    { ORDATA (PR5.BITNO, PR[5].BITNO, 18) },
    { ORDATA (PR6.BITNO, PR[6].BITNO, 18) },
    { ORDATA (PR7.BITNO, PR[7].BITNO, 18) },

...
void scu_init (void);
t_stat scu_sscr (uint scu_unit_num, uint cpu_unit_num, word18 addr, word36 rega, word36 regq);
t_stat scu_smic (uint scu_unit_num, uint cpu_unit_num, word36 rega);

...
struct opCode NonEISopcodes[01000] = {
    ...
    {NULL, 0, 0, 0},
    {NULL, 0, 0, 0},
    {"adlx0", READ_OPERAND | NO_RPT, NO_CSS, 0},
    ...
    {"asx0", RMW | NO_RPT | NO_RPL, NO_DDCSS, 0},
    ...
    {"adx0", READ_OPERAND | NO_RPT, NO_CSS, 0},
    ...
    /* 100 */
    {"cmpx0", READ_OPERAND | NO_RPT, NO_CSS, 0},
    ...
    {"sblx0", READ_OPERAND | NO_RPT, NO_CSS, 0},
    ...
    {"ssx0", RMW | NO_RPT | NO_RPL, NO_DDCSS, 0},
    ...
    {NULL, 0, 0, 0},
    {"sbx0", READ_OPERAND | NO_RPT, NO_CSS, 0},
    ...
    /* 200 */
    {"cnax0", READ_OPERAND | NO_RPT, NO_CSS, 0},
    ...
    {"ldx0", READ_OPERAND | NO_RPT | NO_RPL, NO_CSS, 0},
    ...
    {"orsx0", RMW | NO_RPT | NO_RPL, NO_DDCSS, 0},
    ...
    /* 300 */
    {"canx0", READ_OPERAND | NO_RPT, NO_CSS, 0},
    ...
    {"lcx0", READ_OPERAND | NO_RPT, NO_CSS, 0},
    ...
    {"ansx0", RMW | NO_RPT | NO_RPL, NO_DDCSS, 0},
    ...
    {"anx0", READ_OPERAND | NO_RPT, NO_CSS, 0},
    ...
    {"sxl0", RMW | NO_RPT | NO_RPL, NO_DDCSS, 0},
    ...
    {"eax0", PREPARE_CA | NO_RPT | NO_RPL, NO_DUDL, 0},
    ...
    {"ersx0", RMW | NO_RPT | NO_RPL, NO_DDCSS, 0},
    ...
    {"erx0", READ_OPERAND | NO_RPT, NO_CSS, 0},
    ...
    {"lxl0", READ_OPERAND | NO_RPT | NO_RPL, NO_CSS, 0},
    ...
    {"stx0", RMW | NO_RPT | NO_RPL, NO_DDCSS, 0},

...
struct opCode NonEISopcodes[01000] = {
    ...
    {"drl", NO_RPT, 0},
    {},
    {"mme2", NO_BAR | NO_RPT, 0},
    {"mme3", NO_BAR | NO_RPT, 0},
    {},
    {"mme4", NO_BAR | NO_RPT, 0},
    {},
    {"nop", PREPARE_CA | NO_RPT, 0},
    {"puls1", NO_RPT, 0},
    {"puls2", NO_RPT, 0},
    {},
    ...
    {"rsw", PREPARE_CA | PRIV_INS | NO_RPT, 0},
    ...
    {"stba", RMW | NO_TAG | NO_RPT, 0},
    {"stbq", RMW | NO_TAG | NO_RPT, 0},
    ...
    {"stca", RMW | NO_TAG | NO_RPT, 0},
    {"stcq", RMW | NO_TAG | NO_RPT, 0},
...
struct opCode EISopcodes[01000] = {
    ...
    {},
    {},
    {"spbp0", STORE_YPAIR | NO_BAR, 0},
    {"spri1", STORE_YPAIR | NO_BAR | NO_RPT, NO_DDCSS, 0},
    {"spbp2", STORE_YPAIR | NO_BAR, 0},
...
// XXX camp is "not normal or bar", but I don't see how to set NO_NORMAL
    ...
    {"arn6", RMW, 0},
    {"arn7", RMW, 0},
    {"spbp4", STORE_YPAIR | NO_BAR, 0},
    {"spri5", STORE_YPAIR | NO_BAR | NO_RPT, NO_DDCSS, 0},
    {"spbp6", STORE_YPAIR | NO_BAR, 0},

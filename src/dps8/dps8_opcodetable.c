...
struct opCode NonEISopcodes[01000] = {
    ...
    {"spri0", STORE_YPAIR | PRIV_INS | NO_RPT, NO_DDCSS,  0},
    {"spbp1", STORE_YPAIR | PRIV_INS | NO_RPT, NO_DDCSS,  0},
    {"spri2", STORE_YPAIR | PRIV_INS | NO_RPT, NO_DDCSS,  0},
    {"spbp3", STORE_YPAIR | PRIV_INS | NO_RPT, NO_DDCSS,  0},
    {"spri", STORE_YBLOCK16 | PRIV_INS | NO_RPT, NO_DDCSS,  0},
    ...
    {"spri4", STORE_YPAIR | PRIV_INS | NO_RPT, NO_DDCSS, 0},
    {"spbp5", STORE_YPAIR | PRIV_INS | NO_RPT, NO_DDCSS, 0},
    {"spri6", STORE_YPAIR | PRIV_INS | NO_RPT, NO_DDCSS, 0},

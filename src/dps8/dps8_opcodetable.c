...
struct opCode NonEISopcodes[01000] = {
    ...
    {"scpr", STORE_YPAIR | NO_TAG | PRIV_INS | NO_RPT, 0},
    {},
    ...
    /* 500 */
    {"rpl", NO_TAG | NO_RPT, 0},   // really wierd XXXX
    {},
    {},
    {},
    {},
    ...
    {"scu", STORE_YBLOCK8 | PRIV_INS | NO_RPT, 0},
    ...
    {"lcpr", READ_OPERAND | NO_TAG | PRIV_INS | NO_RPT, 0},
    {"era", READ_OPERAND, 0},
    {"erq", READ_OPERAND, 0},

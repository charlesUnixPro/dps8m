        ...
        case 0075:  // ada
          {
            ...
            bool ovf;
            word18 ir = cpu . cu . IR;
            word36 tmp = Add36b (cpu . rA, cpu.CY, 0, I_ZERO | I_NEG | I_OFLOW | I_CARRY,
                                 & ir, & ovf);
            if (ovf && tstOVFfault ())
              {
                SET_I_OFLOW;
        ...
        case 0076:   // adq
          {
            bool ovf;
            word18 ir = cpu . cu . IR;
            word36 tmp = Add36b (cpu . rQ, cpu.CY, 0, I_ZERO | I_NEG | I_OFLOW | I_CARRY,
                                 & ir, & ovf);
            if (ovf && tstOVFfault ())
              {
                SET_I_OFLOW;
        ...
        case 0054:   // aos
          {
            ...
            bool ovf;
            word18 ir = cpu . cu . IR;
            word36 tmp = Add36b (cpu.CY, 1, 0, I_ZERO | I_NEG | I_OFLOW | I_CARRY,
                                 & ir, & ovf);
            if (ovf && tstOVFfault ())
              {
                SET_I_OFLOW;
        ...
        case 0175:  // sba
          {
            ...
            bool ovf;
            word18 ir = cpu . cu . IR;
            word36 tmp = Sub36b (cpu . rA, cpu.CY, 1, I_ZERO | I_NEG | I_OFLOW | I_CARRY,
                                 & ir, & ovf);
            if (ovf && tstOVFfault ())
              {
                SET_I_OFLOW;
        ...
        case 0176:  // sbq
          {
            ...
            bool ovf;
            word18 ir = cpu . cu . IR;
            word36 tmp = Sub36b (cpu . rQ, cpu.CY, 1, I_ZERO | I_NEG | I_OFLOW | I_CARRY,
                                 & ir, & ovf);
            if (ovf && tstOVFfault ())
              {
                SET_I_OFLOW;
